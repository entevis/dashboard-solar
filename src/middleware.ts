...
export async function middleware(request: NextRequest) {
  ...
  const isPublicPath = pathname.startsWith("/login") || pathname.startsWith("/api/auth") || pathname.startsWith("/api/webhooks") || pathname.startsWith("/api/cron") || pathname.startsWith("/forgot-password");
